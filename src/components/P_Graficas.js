...
const Graficas = (props) => {
    ...
    let {id,nombre,tipo,velocidad,img,coprocesador,memoria,interfaz,tokens} = props.el;
    let balance = props.balance;
    let setAccountBalance = props.setAccountBalance;
        return(
            <div className="product extend-650">
                ...
                <div className="datos-producto">
                    <ol>
                        <li>Tipo: {tipo}</li>
                        <li>Coprocesador: {coprocesador}</li>
                        <li>Velocidad: {velocidad}</li>
                        <li>Memoria: {memoria}</li>
                        <li>Interfaz de tarjeta: {interfaz}</li>
